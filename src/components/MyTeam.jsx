...
export default function MyTeam() {
    ...
    const [rowData, setRowData] = useState([
        ...
        { id: 8, Position: "Total", Player: "", Opponent: "", average_score: "", actual_score: ""},
        { id: 9, Position: "Bench", Player: "CJ Stroud", Opponent: "Penn State", average_score: "27.4", actual_score: "25.3"},
    ...
    return (
        <div className="flex justify-center items-center flex-col">
            <div className="bg-white rounded-md m-5 p-5 w-full max-w-3xl">
            ...
            <div className="ag-theme-quartz m-5" style={{ height: '500px', width: '100%' }}>
                <AgGridReact
                    rowData={rowData}
